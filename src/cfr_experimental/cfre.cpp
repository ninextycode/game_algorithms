...
template<RegretDataKey RKey>
void CFRE<RKey>::initInfoStates() {
    initInfoStatesRecursively(root_node_);
}

template<RegretDataKey RKey>
void CFRE<RKey>::initInfoStatesRecursively(const shared_ptr<const GameNode> node) {
...
template<RegretDataKey RKey>
const RegretDataMap<RKey>& CFRE<RKey>::getStrategyInfoSets() {
    return infosets_;
}

template<RegretDataKey RKey>
vector<double> CFRE<RKey>::evaluateAndUpdateRegretSum(
...
template<RegretDataKey RKey>
vector<double> CFRE<RKey>::evaluateRegretSum() {
...
template<RegretDataKey RKey>
vector<double> CFRE<RKey>::processNode(
...
*/
template<RegretDataKey RKey>
vector<double> CFRE<RKey>::processDecisionNode(
    const shared_ptr<const GameNode> node,
    const vector<double>& p_past_actions,
    double p_past_chances,
    bool accumulate_regsum,
...
template<RegretDataKey RKey>
vector<double> CFRE<RKey>::processChanceNode(
    const shared_ptr<const GameNode> node,
    const vector<double>& p_past_actions,
    double p_past_chances,
    bool accumulate_regsum,
...
template<RegretDataKey RKey>
vector<double> CFRE<RKey>::processTerminalNode(
    const shared_ptr<const GameNode> node
) {
